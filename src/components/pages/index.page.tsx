...
export default function IndexPage() {
	...
	const features = [
		{
			...
			description:
				"Industry-standard security to keep your data safe and protected.",
		},
		{
		...
		},
		{
			...
			description:
				"Clean, well-documented code that's easy to customize and extend.",
		},
		{
			icon: <Sparkles className="w-6 h-6 text-green-500" />,
			title: "Modern Stack",
			description:
				"Built with the latest technologies for a seamless developer experience.",
		},
		{
			icon: <ArrowUpRight className="w-6 h-6 text-cyan-500" />,
			title: "Easy Integration",
			description:
				"Quickly add authentication to your existing or new projects.",
		},
	];
	...
	return (
		<div className="min-h-screen bg-gradient-to-b from-mauve-1 to-mauve-2 relative overflow-hidden">
			...
			<FloatingElement className="absolute top-1/8 left-1/3 opacity-20">
				<div className="w-16 h-16 rounded-full bg-mauve blur-xl" />
			</FloatingElement>
			<FloatingElement className="absolute top-2/8 left-2/3 opacity-20">
				<div className="w-16 h-16 rounded-full bg-peach blur-xl" />
			</FloatingElement>
			<FloatingElement className="absolute top-1/4 left-10 opacity-20">
				<div className="w-16 h-16 rounded-full bg-flamingo blur-xl" />
			</FloatingElement>
			<FloatingElement
				className="absolute top-2/3 right-20 opacity-20"
				delay={1}
			>
				<div className="w-24 h-24 rounded-full bg-sky blur-xl" />
			</FloatingElement>
			<FloatingElement
				className="absolute top-1/3 right-1/4 opacity-20"
				delay={2}
			>
				<div className="w-12 h-12 rounded-full bg-sapphire blur-xl" />
			</FloatingElement>
			<FloatingElement className="absolute top-2/4 left-1/3 opacity-20">
				<div className="w-16 h-16 rounded-full bg-sky blur-xl" />
			</FloatingElement>
			<FloatingElement
			...
			<FloatingElement
				className="absolute top-2/3 right-3/4 opacity-20"
				delay={2}
			>
				<div className="w-12 h-12 rounded-full bg-sapphire blur-xl" />
			</FloatingElement>
			<div className="container mx-auto px-4 py-16 md:py-24">
				...
				>
					...
					>
						Welcome to{" "}
						<motion.span
							className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-mauve to-purple-500"
					...
					>
						A modern authentication template built with TanStack Start, Better
						Auth, Drizzle ORM, and Tailwind CSS. Get started in seconds with our
						secure and customizable auth solution.
					</motion.p>
				...
				>
					...
					<p className="text-mauve-11 mb-8 max-w-2xl mx-auto text-lg">
						Join the community of developers using TanStack x Better Auth for
